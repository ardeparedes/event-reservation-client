...
const Reservations = () => {
    ...
    const fetchEvents = async () => {
        try {
            const response = await axios.get(`/api/user/reservations?page=${currentPage}`);
    ...
    return (
        ...
        >
            <Head>
                <title>Laravel - Reservations</title>
            </Head>
                                    ...
                                    <tbody className="bg-white divide-y divide-gray-200">
                                        {events.map((event) => (
                                            <tr key={event.id}>
                                                ...
                                                <td className="p-4 whitespace-nowrap">{event.attendee_limit}</td>
